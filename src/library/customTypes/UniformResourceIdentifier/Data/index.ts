...
class DataURI
  ...
  public static override forciblyParsedFrom = (
    ...
    const parsedData = outcomeOfParsingData.forciblyUnwrap(/* TODO: move to guard statement */);
    ...
    const parsedMediaType = outcomeOfParsingMediaType.forciblyUnwrap(/* TODO: move to guard statement */);
